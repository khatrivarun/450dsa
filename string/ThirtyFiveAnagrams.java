...
public class ThirtyFiveAnagrams {
  ...
  public static void main(String[] args) {
    ThirtyFiveAnagrams thirtyFiveAnagrams = new ThirtyFiveAnagrams();

    String[] arr1 = { "act", "god", "cat", "dog", "tac" };
    System.out.println(thirtyFiveAnagrams.anagrams(arr1));

    String[] arr2 = { "no", "on", "is" };
    System.out.println(thirtyFiveAnagrams.anagrams(arr2));
